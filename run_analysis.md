run_analysis
============
Last updated 2016-10-12 23:11:06 using R version 3.3.1 (2016-06-21).
...
```
## [1] "/Users/Joey/Desktop/UCI HAR Dataset"
```
...
**See the `README.txt` file in /Users/Joey/Desktop/UCI HAR Dataset for detailed information on the dataset.**
...
```
## Error in fread(file.path(pathIn, "train", "subject_train.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea84bdad900
```
...
```
## Error in fread(file.path(pathIn, "test", "subject_test.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea844cdc9514
```
...
```
## Error in fread(file.path(pathIn, "train", "Y_train.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea843e4316a4
```
...
```
## Error in fread(file.path(pathIn, "test", "Y_test.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea84268388eb
```
...
```
## Warning in file(file, "rt"): 无法打开文件'/Users/Joey/Desktop/UCI HAR
## Dataset/UCI HAR Dataset/train/X_train.txt': No such file or directory
```
...
```
## Warning in file(file, "rt"): 无法打开文件'/Users/Joey/Desktop/UCI HAR
## Dataset/UCI HAR Dataset/test/X_test.txt': No such file or directory
```
...
```
## Error in fread(file.path(pathIn, "features.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea84b4beb8a
```
...
```
## Error in fread(file.path(pathIn, "activity_labels.txt")): File is empty: /var/folders/sv/fp3hnl2110d9fpx5gpdsyz4h0000gn/T//RtmpJTUgk5/filea84455bfa77
```
